...
if(isset($_POST["nome"]) && isset($_POST["descricao"]) && isset($_POST["prazo"]) && isset($_POST["projeto"]) && isset($_POST["responsavel"]) && isset($_POST["acao"])){
    
    if(!empty($_POST["nome"]) && !empty($_POST["descricao"]) && !empty($_POST["prazo"]) && !empty($_POST["projeto"]) && !empty($_POST["responsavel"]) && !empty($_POST["acao"])){
